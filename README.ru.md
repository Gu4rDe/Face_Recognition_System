...
- **Аутентификация администратора** — вход, регистрация с инвайт-кодами, сброс пароля, управление JWT Bearer-токеном
...
- **Настройки** — переключение темы (светлая/тёмная), настраиваемый базовый URL API, параметры распознавания лиц (разрешение камеры, FPS), постоянное хранение
...
|-----------|----------|--------------|
| Тема | Светлая / Тёмная | Светлая |
| Базовый URL API | URL бэкенд-сервера | `http://localhost:8000` |
| Разрешение камеры | Разрешение захвата веб-камеры | 640x480 |
